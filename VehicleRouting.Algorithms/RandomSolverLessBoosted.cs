/*
 * Tweaked the number of iterations in RandomSolverBoosted (10% higher, likely better for more powerful computers) 
 */
...
{
    public class RandomSolverLessBoosted : Abstract
    {
        public RandomSolverLessBoosted(
            int seed,
        ...
        {
            for (int attempt = 1; attempt <= 550; attempt++)
            {
