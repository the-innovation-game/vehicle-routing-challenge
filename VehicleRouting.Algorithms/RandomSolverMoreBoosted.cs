/*
 * Tweaked the number of iterations in RandomSolverBoosted (10% lower, likely better for less powerful computers) 
 */
...
{
    public class RandomSolverMoreBoosted : Abstract
    {
        public RandomSolverMoreBoosted(
            int seed,
